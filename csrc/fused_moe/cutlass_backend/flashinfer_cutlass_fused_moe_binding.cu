...
class FusedMoeRunner : public tvm::ffi::ModuleObj {
 ...
 private:
  ...
  kernels::QuantParams getQuantParams(
    ...
    if (isFp8Quant()) {
      if (!quant_scales.has_value()) {
        // Experimental FP8 path without explicit dequant/quant scales.
        return kernels::QuantParams::FP8(nullptr, nullptr, nullptr, nullptr, nullptr, false);
      }
