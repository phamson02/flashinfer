...
template <typename Arch, typename T, typename WeightType, typename OutputType,
          ...
          DualWeightTmaWarpSpecializedGroupedGemmInput::EpilogueFusion FUSION, typename TileShape,
          typename ClusterShape, bool IsMXFPX, bool DYNAMIC_CGA, bool BIAS, bool SwapAB,
          bool UseCustomSchedule = false>
void dual_weight_tma_warp_specialized_generic_moe_gemm_kernelLauncher(
    DualWeightTmaWarpSpecializedGroupedGemmInput hopper_input, int num_experts, int multi_processor_count,
