...
struct Routine_Arguments {
  ...
  ElementWeight* ptr_fc1_upper{};
  ElementWeight* ptr_fc1_lower{};
...
struct DualWeight_Fused_Moe_Kernel_traits_sm80 {
  ...
  // MMA atom arch and layout, maybe let's just hardcode fp16
  ...
  using SmemLayoutB = decltype(cute::tile_to_shape(
      SmemLayoutAtomB{}, cute::make_shape(cute::shape<1>(TileShape{}), cute::shape<2>(TileShape{}) / cute::Int<2>{},
  ...
  struct SharedStorageNormal : cute::aligned_struct<128> {
    ...
    cute::array_aligned<uint16_t, cute::cosize_v<SmemLayoutB>> smem_fc1_weight_upper;
    cute::array_aligned<uint16_t, cute::cosize_v<SmemLayoutB>> smem_fc1_weight_lower;
    cute::array_aligned<ElementOutput, cute::cosize_v<SmemLayoutO>> smem_o;
  };

  struct SharedStorageGate : cute::aligned_struct<128> {
    cute::array_aligned<ElementInput, cute::cosize_v<SmemLayoutA>> smem_input;
    cute::array_aligned<uint16_t, cute::cosize_v<SmemLayoutB>> smem_fc1_gate_weight_upper;
    cute::array_aligned<uint16_t, cute::cosize_v<SmemLayoutB>> smem_fc1_weight_upper;
    cute::array_aligned<uint16_t, cute::cosize_v<SmemLayoutB>> smem_fc1_gate_weight_lower;
    cute::array_aligned<uint16_t, cute::cosize_v<SmemLayoutB>> smem_fc1_weight_lower;
    cute::array_aligned<ElementOutput, cute::cosize_v<SmemLayoutO>> smem_o;
  };
